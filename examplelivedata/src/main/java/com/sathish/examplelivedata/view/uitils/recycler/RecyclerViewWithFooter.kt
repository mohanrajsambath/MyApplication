...
import com.sathish.examplelivedata.view.uitils.recycler.OnLoadMoreListener
import com.sathish.examplelivedata.view.uitils.recycler.RecyclerViewUtils
...
class RecyclerViewWithFooter : androidx.recyclerview.widget.RecyclerView {
    ...
    private var mTemplateList: List<Blog>? = null
    ...
    fun update(templateList: List<Blog>) {
